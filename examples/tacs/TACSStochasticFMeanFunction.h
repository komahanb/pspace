#ifndef TACS_STOCHASTIC_FMEAN_FUNCTION
#define TACS_STOCHASTIC_FMEAN_FUNCTION

#include "TACSFunction.h"
#include "ParameterContainer.h"

class TACSStochasticFMeanFunction : public TACSFunction {
 public:
  TACSStochasticFMeanFunction( TACSAssembler *tacs,
                               TACSFunction *dfunc, 
                               ParameterContainer *pc,
                               int quantityType, 
                               int moment_type = 0);
  ~TACSStochasticFMeanFunction();
  /**
     Get the object name
  */
