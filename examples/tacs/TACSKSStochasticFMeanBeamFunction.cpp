...
TACSKSStochasticFMeanBeamFunction::TACSKSStochasticFMeanBeamFunction( TACSAssembler *tacs,
                                                                      TACSFunction *dfunc,
...
TACSKSStochasticFMeanBeamFunction::~TACSKSStochasticFMeanBeamFunction()
{
  delete [] this->ksSum;
...
void TACSKSStochasticFMeanBeamFunction::initEvaluation( EvaluationType ftype )
{
...
void TACSKSStochasticFMeanBeamFunction::elementWiseEval( EvaluationType evalType,
                                                         int elemIndex,
                                                         TACSElement *element,
                                                         double time,
                                                         TacsScalar tscale,
...
void TACSKSStochasticFMeanBeamFunction::finalEvaluation( EvaluationType evalType )
{
  if (evalType == TACSFunction::INITIALIZE){
    TacsScalar temp;
...
*/
TacsScalar TACSKSStochasticFMeanBeamFunction::getFunctionValue(){  
  return getExpectation();
}

TacsScalar TACSKSStochasticFMeanBeamFunction::getExpectation(){
...
TacsScalar TACSKSStochasticFMeanBeamFunction::getVariance(){
  TacsScalar fvar = 0.0;
...
void TACSKSStochasticFMeanBeamFunction::getElementSVSens( int elemIndex, TACSElement *element,
                                                          double time,
...
void TACSKSStochasticFMeanBeamFunction::addElementDVSens( int elemIndex, TACSElement *element,
