...
void TACSStochasticVarianceFunction::getElementSVSens( int elemIndex, TACSElement *element,
                                                       double time,
...
void TACSStochasticVarianceFunction::addElementDVSens( int elemIndex, TACSElement *element,
