 ...
 *  SamplingOUU implements a C++ example showing how to interface with IPOPT
 ...
 *
 */
class SamplingOUU : public TNLP
{
public:
  /** default constructor */
  SamplingOUU( int nA, int nB, int nC, double tf, int num_steps,
...
private:
  SamplingOUU(const SamplingOUU&);
  SamplingOUU& operator=(const SamplingOUU&);
