...
class ValidateCoordinateSystem(CoordinateSystem, MonomialCoordinateSystemMixin):
    """
    Validation-oriented coordinate system.

    Delegates numerical work while capturing metadata for robustness and resource
    evaluation (e.g., last matrix condition number, last residual norms).
    """
    ...
    def decompose(
        ...
        self._store("last_decompose_coeffs", coeffs)
        return coeffs
    ...
    def reconstruct(
        ...
        self._store("last_reconstruction", recon)
        return recon
...
CoordinateSystem = ValidateCoordinateSystem
